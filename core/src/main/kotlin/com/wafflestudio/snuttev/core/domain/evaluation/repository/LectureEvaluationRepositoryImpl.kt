...
class LectureEvaluationRepositoryImpl(
    private val queryFactory: JPAQueryFactory,
) : LectureEvaluationRepositoryCustom {
    ...
    private fun JPAQueryFactory.selectEvaluationWithSemesterDto(userId: String) =
        select(
            ...
            .innerJoin(lectureEvaluation.semesterLecture, semesterLecture)
            .leftJoin(lectureEvaluation.evaluationLikes, evaluationLike)
            .on(evaluationLike.userId.eq(userId))

    private fun JPAQueryFactory.selectEvaluationWithLectureDto(userId: String) =
        select(
