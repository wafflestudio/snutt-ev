...
class EvaluationServiceTest
    ...
    constructor(
        ...
        @MockitoBean private val mongoService: MongoService,
    ) {
        @BeforeEach
        fun setup() {
            val lecture =
        ...
        fun `test - getEvaluationsOfLecture - ordering`() {
            ...
            val semesterLecture2010Spring =
                semesterLectureRepository.findByYearAndSemesterAndLecture(
                    2010,
                    Semester.SPRING.value,
                    lecture,
                )!!
            val semesterLecture2010Autumn =
                semesterLectureRepository.findByYearAndSemesterAndLecture(
                    2010,
                    Semester.AUTUMN.value,
                    lecture,
                )!!
            val semesterLecture2020Spring =
                semesterLectureRepository.findByYearAndSemesterAndLecture(
                    2020,
                    Semester.SPRING.value,
                    lecture,
                )!!
            val semesterLecture2020Autumn =
                semesterLectureRepository.findByYearAndSemesterAndLecture(
                    2020,
                    Semester.AUTUMN.value,
                    lecture,
        ...
        private fun saveLectureEvaluationsForMultipleLectures(
            userId: String,
            count: Int,
        ) {
